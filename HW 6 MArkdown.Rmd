...
# This dataset is about the lower 48 states through 1982 through 1988. This dataset measures traffic fatality rate in the number of traffic deaths in a given state, in a given year, per 10,000 people living in that state in that year.There are also many variables used in this study, some examples are beertax, jail-time, Salaries, and Un-employment.Personal income was obtained from BLS. Unemployment rate was taken from U.S. Bureau of Labor Statstics. Total vehicles miles driven was taken from Department of Transportation. 

#This is a plot of the dependent variable
plot(B$mrall)
#This is a plot of the dependant variable in regards to the years 1982-1988
plot(B$year,B$mrall)
